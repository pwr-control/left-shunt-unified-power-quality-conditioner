...
video_duration = 6.0;
fps            = 30;
output_file    = 'video_plot_dab_advanced_2.mp4';
...
title(ax_v,'DAB AC Voltages - During Line Voltage Sag','Color','w','FontSize',font_size_title,'FontWeight','normal');
...
legend(ax_i,{'i_{dab,ac}'},'TextColor','w', ...
       'Color','none','EdgeColor',[0.4 0.4 0.4],'Location','northeast','FontSize',font_size_legend);
title(ax_i,'DAB AC Current - During Line Voltage Sag','Color','w','FontSize',font_size_title,'FontWeight','normal');
...
legend(ax_v1,{'u_{Q1,ds}'},'TextColor','w', ...
    'Color','none','EdgeColor',[0.4 0.4 0.4],'Location','northeast','FontSize',font_size_legend);
title(ax_v1,'DAB Q1-Uds Voltage - During Line Voltage Sag','Color','w','FontSize',font_size_title,'FontWeight','normal');
...
legend(ax_v2,{'u_{Q1,gs}'},'TextColor','w', ...
    'Color','none','EdgeColor',[0.4 0.4 0.4],'Location','northeast','FontSize',font_size_legend);
title(ax_v2,'DAB Q1-Ugs Voltage - During Line Voltage Sag','Color','w','FontSize',font_size_title,'FontWeight','normal');
...
legend(ax_i,{'i_{Q1,ds}','i_{Q2,ds}'},'TextColor','w', ...
    'Color','none','EdgeColor',[0.4 0.4 0.4],'Location','northeast','FontSize',font_size_legend);
title(ax_i,'DAB Q1, Q2 -Ids Current - During Line Voltage Sag','Color','w','FontSize',font_size_title,'FontWeight','normal');
ylabel(ax_i,'Current  [A]','Color','w','FontSize',font_size_labels);
xlabel(ax_i,'Time  [s]','Color','w','FontSize',font_size_labels);
xlim(ax_i,[t1,t2]); ylim(ax_i,[yi_min,yi_max]);
