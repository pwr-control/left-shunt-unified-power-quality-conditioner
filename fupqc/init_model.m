clear;
[model, options] = init_environment('upqc');
...
use_dq_pll_mode2_modn = 0;
use_dq_pll_mode3_modn = 1;
use_dq_pll_mode4_modn = 0;
...
%---
%[metadata:view]
%   data: {"layout":"onright","rightPanelPercent":37.4}
%---
